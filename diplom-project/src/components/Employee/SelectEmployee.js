                            ...
                            employee.map((employee, i) =>{
                                return(
                                    <tr key={i}>
                                        ...
                                        <td><FontAwesomeIcon style={{cursor: 'pointer', color: '#1560BD'}} onClick={() => {navigate('/pinning_employee')}}  icon={faUserLock}/></td>
                                        <td><FontAwesomeIcon style={{cursor: 'pointer', color: 'red'}} icon={faUserSlash} onClick={() => {DeleteEmployee(employee.employee_id); window.location.reload()}}/></td>
                                    </tr>
                                )
                            })
                        }
