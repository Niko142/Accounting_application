                ...
                <div className="util-modal">
                    <div className="repair-content">
                        ...
                        <div style={{width: '660px', padding: '22px'}}>
                            ...
                            <Button isActive style={{float: 'left'}} onClick={RepairScreen}>Отправить в ремонт</Button>
                            <Button isActive style={{float: 'right'}} onClick={() => setActive(false)}>Назад</Button>
                        </div>
                    </div>
                </div>
                            ...
                            screen.map((screen, i) =>{
                                return(
                                    <tr key={i}>
                                        ...
                                        <td>
                                            <button className="util" onClick={() => {setModal(true) ;ViewScreen(screen.screen_id)}}><FontAwesomeIcon style={{color: 'fff', cursor: 'pointer', marginRight: '7px'}} icon={faTrash}/>Утилизация</button>
                                            <button className='repair' onClick={() => {setRepair(true) ;ViewScreen(screen.screen_id)}}> <FontAwesomeIcon style={{color: 'fff', cursor: 'pointer', marginRight: 'px'}} icon={faScrewdriverWrench}/>Ремонт</button>
                                        </td>
                                    </tr>
                                )
                            })
