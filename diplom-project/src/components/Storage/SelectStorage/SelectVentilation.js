            ...
            <div className="util-modal">
                <div className="util-content">
                    ...
                    <div style={{marginTop: '1rem', width: '660px', padding: '22px'}}>
                        ...
                        <label className="add">Наименование утилизируемой системы вентиляции</label>
                ...
                <div className="util-modal">
                    <div className="repair-content">
                        ...
                        <div style={{width: '660px', padding: '22px'}}>
                            ...
                            <Button isActive style={{float: 'left'}} onClick={RepairVentilation}>Отправить в ремонт</Button>
                            <Button isActive style={{float: 'right'}} onClick={() => setActive(false)}>Назад</Button>
                        </div>
                    </div>
                </div>
                            ...
                            ventilation.map((ventilation, i) =>{
                                return(
                                    <tr key={i}>
                                        ...
                                        <td>
                                            <button className="util" onClick={() => {setModal(true) ;ViewVentilation(ventilation.ventilation_id)}}><FontAwesomeIcon style={{color: 'fff', cursor: 'pointer', marginRight: '7px'}} icon={faTrash}/>Утилизация</button>
                                            <button className='repair' onClick={() => {setRepair(true) ;ViewVentilation(ventilation.ventilation_id)}}> <FontAwesomeIcon style={{color: 'fff', cursor: 'pointer', marginRight: '7px'}} icon={faScrewdriverWrench}/>Ремонт</button>
                                        </td>
                                    </tr>
                                )
                            })
