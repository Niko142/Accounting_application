                ...
                <div className="util-modal">
                    <div className="repair-content">
                        ...
                        <div style={{width: '660px', padding: '22px'}}>
                            ...
                            <Button isActive style={{float: 'left'}} onClick={RepairLaptop}>Отправить в ремонт</Button>
                            <Button isActive style={{float: 'right'}} onClick={() => setActive(false)}>Назад</Button>
                        </div>
                    </div>
                </div>
                            ...
                            laptop.map((laptop, i) =>{
                                return(
                                    <tr key={i}>
                                        ...
                                        <td>
                                            <button className="util" onClick={() => {setModal(true) ;ViewLaptop(laptop.laptop_id)}}><FontAwesomeIcon style={{color: 'fff', cursor: 'pointer', marginRight: '7px'}} icon={faTrash}/>Утилизация</button>
                                            <button className='repair' onClick={() => {setRepair(true) ;ViewLaptop(laptop.laptop_id)}}> <FontAwesomeIcon style={{color: 'fff', cursor: 'pointer', marginRight: 'px'}} icon={faScrewdriverWrench}/>Ремонт</button>
                                        </td>
                                    </tr>
                                )
                            })
