    ...
    return(
        ...
        <section id='sec'>
            <div className="sec" style={{display: 'block',textAlign: 'center'}}>
                            ...
                            processor.map((processor, i) =>{
                                return(
                                    <tr key={i}>
                                        ...
                                        <td><FontAwesomeIcon onClick={()=>{DeleteProcessor(processor.id_processor); window.location.reload()}} style={{color: 'red', cursor: 'pointer'}} icon={faTrash}/></td>
                                    </tr>
                                )
                            })
                        }
                ...
                <div> 
                    <Button isActive onClick = {() => navigate('/add_components')}>Добавить процессор </Button>
                </div>
            </div>
        </section>
        </>
