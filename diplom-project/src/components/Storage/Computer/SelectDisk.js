    ...
    return(
        ...
        <section id='sec'>
            <div className="sec" style={{display: 'block',textAlign: 'center'}}>
                            ...
                            disk.map((disk, i) =>{
                                return(
                                    <tr key={i}>
                                        ...
                                        <td><FontAwesomeIcon onClick={()=>{DeleteDisk(disk.id_disk); window.location.reload()}} style={{color: 'red', cursor: 'pointer'}} icon={faTrash}/></td>
                                    </tr>
                                )
                            })
                        }
                ...
                <div> 
                    <Button isActive  onClick = {() => navigate('/add_components')}>Добавить диск</Button>
                </div>
            </div>
        </section>
        </>
