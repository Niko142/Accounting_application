...
export default function LaptopSelection() {
  ...
  return (
    <form style={{ width: '420px' }} onSubmit={FormSubmit}>
      ...
      <label htmlFor="systems" className="add">
      ...
      <input
        ...
        id="form-input"
        name="videocard"
        value={laptop.videocard}
        style={{ borderColor: errors.videocard ? 'red' : null }}
        onChange={handleLaptopChange}
      />
      ...
      <input
        ...
        style={{ borderColor: errors.processor ? 'red' : null }}
        onChange={handleLaptopChange}
      />
      ...
      <input
        ...
        name="memory"
        value={laptop.memory}
        style={{ borderColor: errors.memory ? 'red' : null }}
        onChange={handleLaptopChange}
      />

      {errors.memory && <span className="err">{errors.memory}</span>}

      <label htmlFor="volume" className="add">
        Объем жесткого диска (в формате `значение` ГБ):
      </label>
      <input
        type="text"
        id="form-input"
        name="volume"
        value={laptop.volume}
        style={{ borderColor: errors.volume ? 'red' : null }}
        onChange={handleLaptopChange}
      />
