...
export default function OfficeMenu() {
  ...
  const DeleteChancellery = (id) => {
    Axios.delete(`http://localhost:3001/delete-chancellery/${id}`).then(
      (res) => {
        console.log(res);
      ...
      <div className="util-modal">
        <div className="amount-content">
          ...
          <div style={{ width: '', padding: '15px' }}>
            ...
            <Button isActive style={{ float: 'right' }} onClick={EditAmounts}>
              Изменить
            </Button>
          </div>
        </div>
                    ...
                    <tr key={i}>
                      ...
                      <td>
                        <button
                          ...
                          onClick={() => {
                            setChange(true);
                            ViewChancellery(res.id_chancellery);
                          }}
                        >
                          Редактировать
                        </button>
                        <button
                          className="util"
                          onClick={() => {
                            DeleteChancellery(res.id_chancellery);
                          }}
                        >
                          Удалить
                        </button>
